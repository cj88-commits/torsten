package com.recordcollection.app.ui.albums
...
import com.recordcollection.app.data.repository.SyncState
...
fun AlbumGridScreen(
    ...
    if (showJumpSheet) {
        ...
        ModalBottomSheet(
            ...
            containerColor = Color(0xFF1C1C30),
        ) {
            Text(
                text = "Jump to",
    ...
    Scaffold(
        ...
        topBar = {
            TopAppBar(
                title = { Text("Record Collection", color = Color.White) },
...
private fun OfflineBanner() {
    Surface(color = Color(0xFF2D2D4E), modifier = Modifier.fillMaxWidth()) {
        Row(
